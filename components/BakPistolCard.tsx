...
export function BakPistolCard({ latihanData }: { latihanData: BakPistol }) {
    ...
    <ScrollView style={styles.container}>
      <Card style={styles.dateCard}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{latihanData.amunisi_kena_sasaran}</Text>
        </View>
        <View style={styles.detailRow}>
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.sectionTitle}>Rincian Sasaran Bak Pistol</Text>

            {latihanData.sasaran_bak_pistol.map((sasaran, idx) => (
